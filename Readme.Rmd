...
```{r echo=FALSE}
# save csv file
write.csv(DAG, "develop/DAG_dat1.csv", row.names = FALSE, quote = TRUE)

lines <- readLines("develop/DAG_dat1.csv")
for (line in lines) {
  cat(line)
  cat("\n")
}
...
The file format for this is plain text CSV that includes edges (From, To) and rank numbers.
