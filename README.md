...
Before any analysis, the dataFormat function decomposes the provided data into an ID vector, data matrix U, missing value index matrix Z, and item weight vector w.